...
<head>
    ...
    <link href="<?php echo base_url('bootstrap-table-1.9.1/src/bootstrap-table.css'); ?>" rel="stylesheet" media="screen">
...
<body>
    ...
    <script src="<?php echo base_url('bootstrap-table-1.9.1/src/bootstrap-table.js'); ?>"></script>
    ...
    <script src="<?php echo base_url('bootstrap-table-1.9.1/src/locale/bootstrap-table-zh-CN.js'); ?>"></script>
